...
from houses.views.public import home, map_view, house_detail_view, support_view, landlord_posts_view
...
urlpatterns = [
    ...
    path('chinh-chu/<int:user_id>/', landlord_posts_view, name='landlord_posts'),
