...
from contracts.views.landlord import (
    manage_contracts, manage_tenants, create_contract, 
    edit_contract, terminate_contract, edit_tenant,
    export_contracts_xlsx, export_tenants_xlsx
)

urlpatterns = [
    path('manage-contracts/', manage_contracts, name='manage_contracts'),
    path('manage-tenants/', manage_tenants, name='manage_tenants'),
    path('dashboard/contracts/export/', export_contracts_xlsx, name='export_contracts_xlsx'),
    path('dashboard/tenants/export/', export_tenants_xlsx, name='export_tenants_xlsx'),
